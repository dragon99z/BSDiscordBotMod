...
namespace BeatSaberDiscordMod
{
    ...
    public class Plugin
    {
        ...
        // public const string HarmonyId = "com.github.YourGitHub.BeatSaberDiscordMod";
        // internal static readonly HarmonyLib.Harmony harmony = new HarmonyLib.Harmony(HarmonyId);

        internal static Plugin Instance { get; private set; }
        internal static IPALogger Log { get; private set; }
        internal static BeatSaberDiscordModController PluginController { get { return BeatSaberDiscordModController.Instance; } }
        ...
        public void OnApplicationStart()
        {
            MainMenuAwaiter.MainMenuInitializing += delegate {
                BeatSaberDiscordModController.Init();
            };
        }
        ...
        {
            Configuration.Init(config.Generated<BotConfig>());
        ...
        {
            new GameObject("BeatSaberDiscordModController").AddComponent<BeatSaberDiscordModController>();
            //ApplyHarmonyPatches();
        }
